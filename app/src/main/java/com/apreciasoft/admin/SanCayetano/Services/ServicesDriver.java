package com.apreciasoft.admin.SanCayetano.Services;

import com.apreciasoft.admin.SanCayetano.Entity.Company;
import com.apreciasoft.admin.SanCayetano.Entity.DriverCurrentAcountEntity;
import com.apreciasoft.admin.SanCayetano.Entity.DriverFull;
import com.apreciasoft.admin.SanCayetano.Entity.InfoTravelEntity;
import com.apreciasoft.admin.SanCayetano.Entity.RequetClient;
import com.apreciasoft.admin.SanCayetano.Entity.acountCompany;
import com.apreciasoft.admin.SanCayetano.Entity.costCenterCompany;
import com.apreciasoft.admin.SanCayetano.Entity.dataAddPlusDriverEntity;
import com.apreciasoft.admin.SanCayetano.Entity.driver;
import com.apreciasoft.admin.SanCayetano.Entity.fleetType;
import com.apreciasoft.admin.SanCayetano.Entity.modelEntity;
import com.apreciasoft.admin.SanCayetano.Entity.resp;
import com.apreciasoft.admin.SanCayetano.Entity.responseFilterVehicle;
